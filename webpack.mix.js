...
*/
mix.styles(['resources/assets/admin/bootstrap/css/bootstrap.min.css',
    ...
    'resources/assets/admin/dist/css/skins/_all-skins.min.cs',
    ...
    'resources/assets/admin/plugins/select2/select2.min.css'], 'public/css/admin.css');


mix.scripts(['resources/assets/admin/plugins/jQuery/jquery-2.2.3.min.js',
    ...
    'resources/assets/admin/plugins/datatables/dataTables.bootstrap.min.js'], 'public/js/admin.js');
...
mix.copy('resources/assets/admin/plugins','public/plugins');


mix.styles(['resources/assets/front/css/bootstrap.min.css',
    ...
    'resources/assets/front/css/owl.transitions.cs',
    'resources/assets/front/css/style.css',
    'resources/assets/front/css/responsive.css'], 'public/css/front.css');
mix.scripts(['resources/assets/front/js/jquery-2.2.3.min.js',
    ...
    'resources/assets/front/js/scripts.js'], 'public/js/front.js');
